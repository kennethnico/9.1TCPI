  ...
  <script>
    ...
    <style>
        .main-banner-C2 {
            ...
            background: linear-gradient(105deg, var(--gradiente-uno) 0%, var(--gradiente-dos) 100%);
        ...
        .main-banner-C2 .left-content {
            margin-right: 45px;
        }

        .main-banner-C2 .left-content h6 {
        ...
        .main-banner-C2 .left-content h2 {
            font-size: 50px;
            font-weight: 700;
            color: #2a2a2a;
            line-height: 72px;
        ...
        .main-banner-C2 .left-content h2 em {
            color: var(--secondary-color);
            font-style: normal;
        }

        .main-banner-C2 .left-content h2 span {
            color: var(--primary-color);
        }

        .main-banner-C2 .left-content p {
            margin: 20px 0px;
        }
        .myC{
            width: 70%!important;
...
<!-- ***** Header Area End ***** -->
<!------------>
<div class="main-banner-C2 wow fadeIn" id="top" data-wow-duration="1s" data-wow-delay="0.5s">
  <div class="container">
      ...
      <div class="row" style="height: 70vh;">
          <div class="container_c myC">
              <h1>Mesa de Test</h1>
              <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s" style="z-index: -1;">
                  <div class="embed-youtube" data-video-id="-ZrXnVocI2Q">
                      <div class="embed-youtube-play"></div>
                  </div>
              </div>
          </div>
